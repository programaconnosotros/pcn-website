...
const influencersData: InfluencersData = {
  influencers: [
    ...
    },
    {
      ...
      description: "Desarrollador Full Stack con más de 10 años de experiencia. Comparte tutoriales sobre programación, tecnologías y herramientas de desarrollo. Cuenta con una comunidad de más de 100k de seguidores en sus redes sociales.",
      platforms: {
    ...
    },
    {
      ...
      image: "mouredev.webp",
      description: "Hola 👋🏼 Mi nombre es Brais Moure. Soy ingeniero de software desde 2010. Actualmente trabajo como freelance fullstack y creo contenido formativo sobre programación y desarrollo en redes",
      platforms: {
