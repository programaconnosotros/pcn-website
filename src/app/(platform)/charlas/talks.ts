...
export const talks: Talk[] = [
  {
    ...
    portrait: '/lightning-talks/arquitectura-software.webp',
  ...
  },
  {
    ...
    portrait: '/lightning-talks/arquitectura-modular.webp',
    date: new Date('2023-05-06'),
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    ...
    portrait: '/lightning-talks/debugging.webp',
    date: new Date('2023-05-06'),
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    ...
    portrait: '/lightning-talks/paradigmas.webp',
    date: new Date('2023-05-06'),
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    ...
    location: 'UTN (Tucumán, Argentina)',
    portrait: '/lightning-talks/la-shell.webp',
  },
  {
    ...
    date: new Date('2023-09-16'),
    location: 'UTN (Tucumán, Argentina)',
    portrait: '/lightning-talks/ingenieria-en-sistemas.webp',
  },
  {
    name: 'Programación optimizada con ChatGPT',
    speakerName: 'Facundo Bazán',
    portrait: '/lightning-talks/chatgpt.webp',
    date: new Date('2023-05-06'),
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    ...
    speakerName: 'Marcelo Núñez',
    portrait: '/lightning-talks/java-funcional.webp',
    date: new Date('2023-05-06'),
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    ...
    portrait: '/lightning-talks/database-indexing.webp',
    date: new Date('2023-09-16'),
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    ...
    speakerName: 'Tobías Paz Posse',
    portrait: '/lightning-talks/unit-testing.webp',
    date: new Date('2023-09-16'),
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    ...
    speakerName: 'Agustín Sánchez',
    portrait: '/lightning-talks/ddd-y-hexagonal-6.webp',
    date: new Date('2023-09-16'),
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    ...
    speakerName: 'Mauricio Sánchez',
    portrait: '/lightning-talks/diseno-perfecto.webp',
    date: new Date('2023-09-16'),
    location: 'UTN (Tucumán, Argentina)',
  },
  ...
  },
  {
    ...
    speakerName: 'Agustín Sánchez & Marcelo Nuñez',
    portrait: '/una-mirada-a-la-industria-del-software.webp',
    location: 'Mercado de Tafí Viejo (Tucumán, Argentina)',
    slides: [
      '/charla-industria-software-24-11-2024/001.webp',
      '/charla-industria-software-24-11-2024/002.webp',
      '/charla-industria-software-24-11-2024/003.webp',
      '/charla-industria-software-24-11-2024/004.webp',
      '/charla-industria-software-24-11-2024/005.webp',
      '/charla-industria-software-24-11-2024/006.webp',
      '/charla-industria-software-24-11-2024/007.webp',
      '/charla-industria-software-24-11-2024/008.webp',
      '/charla-industria-software-24-11-2024/009.webp',
      '/charla-industria-software-24-11-2024/010.webp',
      '/charla-industria-software-24-11-2024/011.webp',
      '/charla-industria-software-24-11-2024/012.webp',
      '/charla-industria-software-24-11-2024/013.webp',
      '/charla-industria-software-24-11-2024/014.webp',
      '/charla-industria-software-24-11-2024/015.webp',
      '/charla-industria-software-24-11-2024/016.webp',
      '/charla-industria-software-24-11-2024/017.webp',
      '/charla-industria-software-24-11-2024/018.webp',
      '/charla-industria-software-24-11-2024/019.webp',
      '/charla-industria-software-24-11-2024/020.webp',
    ],
  },
  {
  ...
  },
  {
    ...
    date: new Date('2024-10-26'),
    speakerName: 'Iván Taddei',
    portrait: '/IMG_9027.webp',
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    name: 'Hello world: Introducción al mundo de la programación',
    date: new Date('2024-10-26'),
    speakerName: 'Matías Gútierrez',
    portrait: '/IMG_8680.webp',
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    name: 'Aprendiendo Machine Learning con calabozos y dragones',
    date: new Date('2024-10-26'),
    speakerName: 'Alejo Boga',
    portrait: '/IMG_8771.jpg',
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    ...
    date: new Date('2024-10-26'),
    speakerName: 'Lucas Pérez',
    portrait: '/IMG_8871.webp',
    location: 'UTN (Tucumán, Argentina)',
  },
  {
    name: 'Claves del testing de software',
    date: new Date('2024-10-26'),
    speakerName: 'Agustín Sánchez',
    portrait: '/IMG_8912.webp',
    location: 'UTN (Tucumán, Argentina)',
  },
  {
  ...
  },
  {
    ...
    speakerName: 'Agustín Sánchez',
    portrait: '/agus-jornada-ciberseguridad.webp',
    location: 'Jornada de Ciberseguridad (Tucumán, Argentina)',
  },
  {
    name: 'Introducción al desarrollo de software',
    date: new Date('2024-11-29'),
    speakerName: 'Mauricio Sánchez',
    portrait: '/IMG_8974.webp',
    location: 'Instituto Montserrat (Tucumán, Argentina)',
  },
  {
    name: 'Paradigmas de programación',
    date: new Date('2024-11-28'),
    speakerName: 'Marcelo Núñez',
    portrait: '/IMG_0618.webp',
    location: 'Jornada de Ciberseguridad (Tucumán, Argentina)',
  },
];
