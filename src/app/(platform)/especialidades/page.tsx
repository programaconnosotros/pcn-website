    ...
    <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
      <div className="mt-4">
        <div className="mb-12 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-center text-muted-foreground max-w-3xl">
              El mundo del software es vasto y diverso. Aquí te presentamos las principales
              especialidades en las que puedes enfocar tu carrera profesional.
            </p>
          </div>
        </div>
        <div className="flex gap-8">
          ...
          >
            <CardHeader>
              <CardTitle>DevOps & Cloud Engineering</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
