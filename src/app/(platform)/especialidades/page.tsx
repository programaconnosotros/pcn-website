      ...
      <div className="mt-4">
        <div className="mb-12 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="flex flex-col items-center gap-4">
            <Heading2 className="m-0 text-center">Especialidades</Heading2>
        ...
        <div className="flex gap-8">
          ...
          <div className="flex flex-1 flex-col items-center gap-6">
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  ...
                  aplicaciones web que los usuarios ven y con la que interactúan directamente en
                  navegadores.
                </p>
                <div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Para personas creativas que disfrutan diseñar interfaces web, trabajar con
                    UX/UI, y ver resultados visuales inmediatos de su trabajo en navegadores.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Los desarrolladores full stack tienen conocimientos tanto de frontend como de
                  backend, permitiéndoles trabajar en todas las capas de una aplicación.
                </p>
                <div>
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para desarrolladores que disfrutan aprender constantemente y trabajar en
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  El desarrollo iOS se enfoca en crear aplicaciones nativas para dispositivos Apple
                  (iPhone, iPad) utilizando las herramientas y frameworks específicos de la
                  plataforma.
                </p>
                <div>
                  <Heading3 className="mb-2 text-lg">Tecnologías principales:</Heading3>
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para desarrolladores interesados en crear aplicaciones nativas para el
                    ecosistema Apple, aprovechando las características únicas de iOS y macOS.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  El desarrollo Android se enfoca en crear aplicaciones nativas para dispositivos
                  Android utilizando las herramientas y frameworks específicos de la plataforma.
                </p>
                <div>
                  <Heading3 className="mb-2 text-lg">Tecnologías principales:</Heading3>
                  <ul className="list-inside list-disc space-y-1 text-muted-foreground">
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para desarrolladores interesados en crear aplicaciones para la plataforma
                    Android más utilizada del mundo, con gran flexibilidad y personalización.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  El desarrollo móvil cross-platform permite crear aplicaciones que funcionan en
                  múltiples plataformas (iOS y Android) usando un solo código base, reduciendo
                ...
                <div>
                  ...
                  <ul className="list-inside list-disc space-y-1 text-muted-foreground">
                    <li>
                      <strong>React Native:</strong> Framework basado en React, permite desarrollo
                      con JavaScript/TypeScript
                    </li>
                    <li>
                      <strong>Expo:</strong> Plataforma y herramientas para React Native que
                      simplifica el desarrollo
                    </li>
                    <li>
                      <strong>Flutter:</strong> Framework de Google usando Dart, con excelente
                      rendimiento y UI nativa
                    </li>
                    <li>
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para desarrolladores que quieren crear aplicaciones móviles para múltiples
                    plataformas de manera eficiente, aprovechando frameworks modernos que permiten
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  DevOps combina desarrollo y operaciones para automatizar y optimizar el ciclo de
                  vida del software, desde el desarrollo hasta el despliegue y mantenimiento.
                </p>
                <div>
                  <Heading3 className="mb-2 text-lg">Tecnologías principales:</Heading3>
                  <ul className="list-inside list-disc space-y-1 text-muted-foreground">
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  La ciencia de datos se enfoca en extraer conocimiento y insights valiosos de
                  grandes volúmenes de datos mediante análisis estadístico, machine learning y
                  visualización.
                </p>
                <div>
                  <Heading3 className="mb-2 text-lg">Tecnologías principales:</Heading3>
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para personas con interés en matemáticas, estadística y encontrar patrones en
                    datos para tomar decisiones basadas en evidencia.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para personas con fuerte base matemática, interés en algoritmos complejos y
                    crear sistemas inteligentes que resuelvan problemas reales.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  La ciberseguridad se enfoca en proteger sistemas, redes y datos de amenazas y
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para personas con mentalidad de resolver puzzles, interés en encontrar y
                    prevenir vulnerabilidades, y proteger información sensible.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  El desarrollo de videojuegos combina programación, diseño, arte y narrativa para
                  crear experiencias interactivas y entretenidas.
                </p>
                <div>
                  <Heading3 className="mb-2 text-lg">Tecnologías principales:</Heading3>
                  <ul className="list-inside list-disc space-y-1 text-muted-foreground">
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para personas detallistas, con ojo crítico para encontrar problemas y asegurar
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para desarrolladores interesados en tecnología descentralizada, criptografía y
                    crear aplicaciones que operen sin intermediarios.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para personas creativas con sentido estético, empatía por los usuarios y pasión
                    por crear experiencias digitales intuitivas y agradables.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  El networking y la infraestructura se enfocan en diseñar, implementar y mantener
                  redes de computadoras y sistemas de comunicación que permiten la conectividad y
            ...
            >
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para personas organizadas, con habilidades de comunicación y liderazgo, que
                    disfrutan coordinar equipos y asegurar que los proyectos se completen
                    exitosamente.
                  </p>
                </div>
              </CardContent>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Un Tech Lead es un desarrollador senior que combina habilidades técnicas profundas
                  con liderazgo, guiando al equipo en decisiones técnicas y arquitectónicas mientras
                  sigue programando activamente.
                </p>
                <div>
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para desarrolladores senior que quieren liderar técnicamente sin dejar de
                    programar, combinando expertise técnico con habilidades de mentoría y
                    comunicación.
                  </p>
                </div>
              </CardContent>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  La gestión de ingeniería se enfoca en liderar equipos de desarrollo, gestionar
                  recursos, establecer procesos y estrategias técnicas, y asegurar que los equipos
                  entreguen software de calidad.
                </p>
                <div>
                  <Heading3 className="mb-2 text-lg">Responsabilidades principales:</Heading3>
                  <ul className="list-inside list-disc space-y-1 text-muted-foreground">
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para ingenieros con experiencia que quieren transicionar a roles de gestión,
                    liderando equipos y estrategias técnicas mientras mantienen conexión con el
                    desarrollo.
                  </p>
                </div>
              </CardContent>
            ...
            >
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  La arquitectura de software se enfoca en diseñar la estructura, organización y
                  patrones fundamentales de sistemas de software complejos, asegurando
                  escalabilidad, mantenibilidad y calidad técnica.
                </p>
                <div>
                  <Heading3 className="mb-2 text-lg">Responsabilidades principales:</Heading3>
                  <ul className="list-inside list-disc space-y-1 text-muted-foreground">
                ...
                <div>
                  <Heading3 className="mb-2 text-lg">¿Para quién es ideal?</Heading3>
                  <p className="text-muted-foreground">
                    Para desarrolladores senior con experiencia en múltiples proyectos, que
                    disfrutan pensar en el panorama general, diseñar soluciones escalables y tomar
