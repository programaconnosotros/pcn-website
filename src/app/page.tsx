          ...
          <div className="flex flex-col items-center space-y-6 text-center">
            <div className="space-y-6">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 dark:text-gray-400 md:text-xl">
                Conectá, aprende y crece con otros profesionales y estudiantes de varias disciplinas
          ...
          <div className="grid gap-6 lg:grid-cols-3 lg:gap-12">
            ...
            <Card>
              <CardContent className="flex flex-col items-center space-y-4 p-6">
                ...
                <p className="text-center text-gray-500 dark:text-gray-400">
                  Descrubrí oportunidades laborales, mostrá tus proyectos y avanzá en tu carrera en
                  la tecnología.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col space-y-4">
              ...
              <p className="text-center text-gray-500 dark:text-gray-400">
                Participá en el desarrollo de la plataforma que estás viendo en este momento, sirve
                para intercambiar conocimiento, ganar experiencia y, sobre todo, para divertirnos!
              </p>
            </div>
