...
export const InviteDevsToWork = () => {
  return (
    <section className="rounded-md px-10 py-16">
        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row">
          <div className="flex-1 text-white">
            ...
            <p className="mb-8 text-xl text-muted-foreground">
              ¿Te apasiona el desarrollo web? ¡Contribuí a este proyecto open-source y afianzate más
              con la comunidad!
            </p>
            ...
            <div className="flex items-center gap-8">
              <div className="mb-10 flex-1">
                ...
                <ul className="space-y-3 [&>li]:text-muted-foreground">
                  ...
                  <li className="flex items-center">
                    <span className="mr-2">🌟</span> Fortalece tu portafolio
                  </li>

                  <li className="flex items-center">
                    <span className="mr-2">🤝</span> Afianza tu relación con otros miembros
                  </li>

                  <li className="flex items-center">
                    <span className="mr-2">💪🏻</span> Ayuda a otros desarrolladores a crecer
                  </li>
                </ul>
              </div>
            ...
            <div>
              ...
              <p className="mb-6 text-muted-foreground">
                Visita nuestro repositorio en GitHub, explora los issues, asignate alguno y enviá tu
                primer PR. Para comunicarte con nosotros, podés usar el canal de Discord o el grupo
                de WhatsApp. ¡Toda contribución cuenta! ¡Animate! 🙌
              </p>
