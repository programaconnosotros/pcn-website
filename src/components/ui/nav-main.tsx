                          ...
                          return (
                            <SidebarMenuSubItem key={subItem.title}>
                              <SidebarMenuSubButton
                                ...
                                className={`transition-transform duration-200 hover:scale-[1.015] ${isSubItemActive ? 'border-l-2 border-pcnPurple bg-pcnPurple/10 text-pcnPurple dark:border-pcnGreen dark:bg-pcnGreen/10 dark:text-pcnGreen dark:[&_span]:drop-shadow-[0_0_8px_rgba(4,244,190,0.8)]' : ''}`}
                              >
                                <a href={subItem.url}>
