  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-input bg-background hover:bg-accent/80 hover:text-accent-foreground hover:border-pcnPurple dark:shadow-[0_0_10px_rgba(0,0,0,0.4)] dark:hover:shadow-[0_0_15px_rgba(0,0,0,0.6)] dark:hover:bg-accent/60 dark:hover:border-pcnGreen dark:hover:shadow-[0_0_15px_rgba(4,244,190,0.4)] dark:text-shadow-[0_0_8px_rgba(255,255,255,0.5)] dark:hover:text-shadow-[0_0_12px_rgba(255,255,255,0.7)] dark:[&_svg]:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] dark:hover:[&_svg]:drop-shadow-[0_0_12px_rgba(255,255,255,0.7)]',
