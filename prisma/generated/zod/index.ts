...
export const EventScalarFieldEnumSchema = z.enum(['id','date','endDate','name','description','city','address','placeName','flyerSrc','latitude','longitude','createdAt','updatedAt']);
